...
import com.bitplan.vzjava.rest.VZServer;

/**
 * test the Volkszähler RESTFul server
 * @author wf
 *
 */
public class TestVZServer extends TestRestServer {
  @Before
  ...
  public RestServer createServer() throws Exception {
    RestServer result = new VZServer();
    return result;
  }
